...
const PrintSalesInvoice = React.forwardRef<HTMLDivElement, Props>(
  ({ salesOrder }, ref) => {
          ...
          <div className="bottom flex items-center justify-between">
            ...
            <div className="right">
              ...
              <span className="font-semibold">
                Sales Invoice No: {salesOrder?.salesNoteNo}
              </span>
            </div>
          </div>
        </header>
        ...
        <div className="content">
            ...
            >
              <div className="content flex-1 flex flex-col gap-y-2">
                <div className="sales-note-no">
                  <span className="mr-4">Sales Invoice No:</span>
          ...
          <div className="right w-full flex items-start justify-end mb-4">
            <div className="content flex flex-col gap-y-3 mt-4">
              <div>
                <span className="font-semibold mr-4 w-24 inline-block">Total:</span>
              ...
              <div>
                <span className="font-semibold mr-4 w-24 inline-block">Charges:</span>
                <span className="mr-1">{salesOrder?.items[0]?.currency} </span>
                {salesOrder?.orderId === "A12S952828" ? "1.00" : "0.00"}
              </div>
              <div>
                <span className="font-semibold mr-4 w-24 inline-block">GST @7%:</span>
                <span className="mr-1">{salesOrder?.items[0]?.currency} </span>
                {salesOrder?.orderId === "A12S952828"
                  ? "0.00"
              ...
              <div>
                <span className="font-semibold mr-4 w-24 inline-block">Grand Total:</span>
                <span className="mr-1">{salesOrder?.items[0]?.currency} </span>
                {salesOrder?.orderId === "A12S952828" ? (
                  "1.00"
                ) : (
