...
import RegularUnitPriceInput from "../FormComponents/Quotes/RegularUnitPriceInput";
import CustomerUnitPriceInput from "../FormComponents/Quotes/CustomerUnitPriceInput";
        ...
        <thead>
          <tr>
            ...
            <th>
              <FormattedMessage
                id="regularUnitPrice"
                defaultMessage={"Regular Unit Price"}
              />
            </th>
            <th>
              <FormattedMessage
                id="customerUnitPrice"
                defaultMessage={"Customer Unit Price"}
              />
            </th>
            <th>
              <FormattedMessage
                id="additionalDiscount"
                defaultMessage={"Additional Dis"}
              />{" "}
              (%)
            </th>
            <th>
              <FormattedMessage
                ...
                defaultMessage={"Promotional Dis"}
              />{" "}
              (%)
            </th>
            <th>
            ...
            <th>
              <FormattedMessage id="totalTax" defaultMessage={"Total Tax"} />
            </th>
            <th>
              <FormattedMessage
                id="shippingCharges"
              ...
              <tr className="w-full" key={item.id}>
                ...
                <td className="flex-1">
                  <RegularUnitPriceInput
                    ...
                    disabled={confirmed}
                    register={register}
                    id={`items.${i}.regularUnitPrice`}
                    name={`items.${i}.regularUnitPrice`}
                    type="number"
                    error={
                      errors?.items
                        ? errors?.items[i]?.regularUnitPrice?.message!
                        : ""
                    }
                  />
                </td>
                <td className="flex-1">
                  <CustomerUnitPriceInput
                    ...
                    showError={false}
                    register={register}
                    id={`items.${i}.customerUnitPrice`}
                    name={`items.${i}.customerUnitPrice`}
                    type="number"
                    error={
                      errors?.items
                        ? errors?.items[i]?.customerUnitPrice?.message!
                        : ""
                    }
                  />
                </td>
                <td className="flex-1">
                  <Input
                    showError={false}
                    register={register}
                    id={`items.${i}.additionalDiscount`}
                    name={`items.${i}.additionalDiscount`}
                    type="number"
                    min={0}
                    disabled={confirmed}
                    max={100}
                    error={
                      errors?.items
                        ? errors?.items[i]?.additionalDiscount?.message!
                        : ""
                    }
                  />
                </td>
                <td className="flex-1">
                  <Input
                    showError={false}
                    register={register}
                    id={`items.${i}.promotionalDiscount`}
                    name={`items.${i}.promotionalDiscount`}
                    type="number"
                    min={0}
                    max={100}
                    disabled={confirmed}
                    error={
                      errors?.items
                        ? errors?.items[i]?.promotionalDiscount?.message!
                        : ""
                    }
                  />
                </td>
                ...
                <td className="flex-1">
                  <Input
                    ...
                    register={register}
                    id={`items.${i}.totalTax`}
                    name={`items.${i}.totalTax`}
                    type="number"
                    min={0}
                    disabled={confirmed}
                    error={
                      errors?.items ? errors?.items[i]?.totalTax?.message! : ""
                    }
                  />
                </td>
                <td className="flex-1">
                  <Input
                    showError={false}
                    register={register}
                    id={`items.${i}.shippingCharges`}
                    name={`items.${i}.shippingCharges`}
                    type="number"
                    min={0}
                    disabled={confirmed}
                    error={
                      errors?.items
                        ? errors?.items[i]?.shippingCharges?.message!
                        : ""
                    }
                  />
                </td>
