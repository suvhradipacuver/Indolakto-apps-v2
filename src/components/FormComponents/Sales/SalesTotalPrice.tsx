...
import { SalesOrderItemsForm } from "../../../types/interfaces";
...
const SalesTotalPrice = ({
  ...
  useEffect(() => {
    ...
    let price = quantity ? quantity * quantityUnitPrice : quantityUnitPrice;
    setValue(`items.${index}.totalPrice`, price.toFixed(2).toString());
  }, [row.quantityUnitPrice, row.quantity, index]);
...
export default SalesTotalPrice;
