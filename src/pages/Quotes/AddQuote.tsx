...
const schema = Yup.object({
  ...
  items: Yup.array<QuoteOrderItemObj>().of(
    Yup.object({
      ...
      regularUnitPrice: Yup.string(),
      customerUnitPrice: Yup.string(),
      additionalDiscount: Yup.string(),
      promotionalDiscount: Yup.string(),
      totalTax: Yup.string(),
...
const ORG_IDS = [
  { label: "PLGA", value: "PLGA" },
  { label: "PLHK", value: "PLHK" },
];
